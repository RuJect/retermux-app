...
public class TermuxUtils {
    ...
    public static Context getContextForPackageOrExitApp(@NonNull Context context, String packageName,
        ...
        return PackageUtils.getContextForPackageOrExitApp(context, packageName, exitAppOnError, TermuxConstants.TERMUX_GIT_REPO_URL);
    }
    ...
    public static String getAPKRelease(String signingCertificateSHA256Digest) {
        ...
        switch (signingCertificateSHA256Digest.toUpperCase()) {
            case TermuxConstants.APK_RELEASE_GIT_SIGNING_CERTIFICATE_SHA256_DIGEST:
                return TermuxConstants.APK_RELEASE_GIT;
            default:
                return "Unknown";
        }
    }
